                    ...
                    >
                        <div className="bg-gradient-to-r from-gray-900/50 to-black/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-800/50 max-w-4xl mx-auto">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <button className="px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-semibold rounded-xl shadow-lg hover:shadow-blue-500/25 transition-all duration-300">
                                    View All Case Studies
                                </button>
                                <button className="px-8 py-3 border border-gray-600 hover:border-blue-500 text-white font-semibold rounded-xl transition-all duration-300">
                                    Start Your Project
                                </button>
                            </div>
                        </div>
