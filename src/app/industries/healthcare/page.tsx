        ...
        <div className="min-h-screen bg-black text-white">
            <div className="container mx-auto px-4 py-20">
                ...
                <p className="text-xl text-white mb-8 max-w-3xl font-body">
                    Digital health solutions that improve patient care, streamline operations, and enhance medical outcomes through innovative technology.
                </p>
                ...
                <div className="bg-neutral-dark/50 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
                    ...
                    <p className="text-white/80 font-body">
                        We're working on comprehensive healthcare industry solutions. Contact us to learn more about our healthcare technology services.
                    </p>
                </div>
            </div>
        </div>
