        ...
        <div className="min-h-screen bg-black text-white">
            <div className="container mx-auto px-4 py-20">
                ...
                <p className="text-xl text-white mb-8 max-w-3xl font-body">
                    Secure fintech platforms and payment solutions that enable digital banking, financial services, and regulatory compliance.
                </p>
                ...
                <div className="bg-neutral-dark/50 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
                    ...
                    <p className="text-white/80 font-body">
                        We're developing comprehensive banking and finance solutions. Contact us to learn more about our fintech services.
                    </p>
                </div>
            </div>
        </div>
