        ...
        <div className="min-h-screen bg-black text-white">
            <div className="container mx-auto px-4 py-20">
                ...
                <p className="text-xl text-white mb-8 max-w-3xl font-body">
                    Seamless shopping experiences that convert visitors into customers through innovative e-commerce platforms and retail technology.
                </p>
                ...
                <div className="bg-neutral-dark/50 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
                    ...
                    <p className="text-white/80 font-body">
                        We're building comprehensive retail and e-commerce solutions. Contact us to learn more about our retail technology services.
                    </p>
                </div>
            </div>
        </div>
