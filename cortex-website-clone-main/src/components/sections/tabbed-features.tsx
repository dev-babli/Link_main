...
const tabData = [
  {
    ...
    title: ['Build your catalog using AI with ', 'Magellan'],
  ...
  },
  {
    id: 1,
    number: '02',
    label: 'Gather insights',
    title: ['Figure out how to unlock your team’s ', 'next level with Engineering Intelligence'],
  ...
  },
  {
    ...
    number: '03',
    label: 'Set standards',
    title: ['Drive best practices with Scorecards ', 'and enforce them directly in the IDE'],
  ...
  },
  {
    ...
    number: '04',
    label: 'Drive action',
    title: ['Autonomy with guardrails through ', 'self-serve with Workflows'],
