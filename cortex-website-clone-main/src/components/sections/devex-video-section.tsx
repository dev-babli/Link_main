        ...
        <div className="flex flex-col items-center justify-center gap-10 text-center lg:gap-14">
          <div className="flex flex-col items-center gap-6">
            ...
            <p className="max-w-4xl text-lg leading-relaxed text-text-secondary">
              Information access is the first step towards a positive developer
              experience. Cortex abstracts away the work required to connect all
              your tools so developers spend less time finding and fixing, and
              more time building—no matter how complex your platform gets.
            </p>
          </div>
